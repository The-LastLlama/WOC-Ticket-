...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        .addComponents(
            ...
            .setLabel("ACE")
            .setStyle("LINK")
            .setURL("https://youtube.com/c/PROGAMERSOUJANYA"),
            new client.discord.MessageButton()
            .setLabel("Support")
            .setStyle("LINK")
            .setURL("https://discord.gg/woc")
        );
        ...
        if (!commandInt) {
            ...
            .addField('To Setup the bot use `/ticket setup`', 'Here Label -> TITLE for embed, reason-> id for database , description -> Description for embed  , .', true)
            .addField('Note','Please do create 2 new categories for tickets to be made  , copy the category id and put it respectively in opencategory & closecategory', true)
            .addField("USE YOUR BRAIN", "FOR THE REST", true)
